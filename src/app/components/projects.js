                ...
                <div className="pj-detail">
                  ...
                  <div className="pj-description">
                    <p className="main-des">
                      실시간으로 소통할 수 있는 협업툴입니다. 기존 앱들과는
                      다르게 필요한 기능만을 사용해 간편하게 이용할 수 있도록
                      개발했습니다.
                    </p>
                    <div className="sub-des">
                      ...
                      <div className="value">
                        ...
                        <p>
                          메세지의 마지막 시간에 따라 채팅방 조회가 가능하고
                          내가 보낸 메세지 수가 많은 인원을 대쉬보드에서
                          보여줍니다.
                        </p>
                      </div>
                    </div>
          ...
          {/* <div className="pj-container">
            ...
            <div className="pj-detail">
              ...
              <div className="pj-description">
                ...
                <div className="hash">
                  <p>#React #typescript #Redux Toolkit #mySQL #SPRING #aws </p>
                </div>
              </div>
            </div>
          </div> */}
